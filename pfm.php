...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <script type="text/javascript" src="pfm.js">
        </script>
    ...
    <body>
        <div id="header">
            <div class="menu">
                <ul class="ribbon">
                    <li class="subdirs">Subdirectories
                    </li>
                    <li class="files">Files
                    </li>
                    <li class="search">Search
                    </li>
                </ul>
                <form id="path-form" name="path-form">
        ...
        <div id="subdirs-menu">
            <form id="subdirs-form" name="subdirs-form">
                <input type="hidden" id="subdirs-action" /> <input type="submit" value="Up" /> <input type="submit" value="New" /> <input type="submit" value="Rename" /> <input type="submit" value="Copy" /> <input type="submit" value="Move" /> <input type="submit" value="Delete" /> <input type="submit" value="Kill" /> <input type="submit" value="Download" /> <input type="submit" value="Select All" />
            </form>
        </div>
        <div id="files-menu">
            <form id="files-form" name="files-form">
                <input type="hidden" id="files-action" /> <input type="submit" value="New" /> <input type="submit" value="Rename" /> <input type="submit" value="Regex Rename" /> <input type="submit" value="Move" /> <input type="submit" value="Copy" /> <input type="submit" value="Duplicate" /> <input type="submit" value="Delete" /> <input type="submit" value="Edit" /> <input type="submit" value="Upload" /> <input type="submit" value="Download" />
            </form>
        </div>
        <div class="ribbon regex-rename">
            <form id="regex-rename-form" name="regex-rename-form">
                <label for="pattern">Pattern</label> <input type="text" id="pattern" /> <label for="replace">Replace</label> <input type="text" id="replace" /> <input type="submit" class="rename" value="Regex Rename" /> <input type="submit" class="confirm" value="Confirm" /> <input id="regex-rename-clear" class="confirm" type="button" value="Clear" />
            </form>
        </div>
        <div id="search-menu" class="ribbon search">
            <label for="filter">Filter</label> <input type="text" id="filter" />
            <form id="search-form" name="search-form">
                <label for="search-query">Advanced Search</label> <input type="text" id="search-query" /> <label for="search-depth">Depth</label> <input type="text" id="search-depth" class="setting" size="1" value="1" /> <label for="search-regex">Regex</label> <input type="checkbox" id="search-regex" class="setting" /> <input type="submit" value="Search" />
            </form>
        </div>
        <div class="ribbon upload">
            <form id="upload-form" name="upload-form">
                <input type="hidden" id="max-file-size" name="MAX_FILE_SIZE" /> <input type="file" id="upload" name="upload[]" multiple="multiple" /> <input type="submit" value="Upload" />
            </form>
        </div>
            ...
            <div class="row">
                <div class="twelve columns">
                    ...
                    <form id="login-form" name="login-form">
                        <input type="password" id="password" /> <input type="submit" value="Login" />
                    </form>
                </div>
            </div>
        </div>
                    ...
                    <table class="files">
                        <thead class="files">
                            <tr>
                                ...
                                <th id="file-name" class="files col-name">
                                    Name
                                </th>
                                <th id="file-size" class="files col-size">
                                    Size
                                </th>
                                <th id="file-owner" class="files col-owner">
                                    Owner
                                </th>
                                <th id="file-group" class="files col-group">
                                    Group
                                </th>
                                <th id="file-perms" class="files col-perms">
                                    Permissions
                                </th>
                                <th id="file-created" class="files col-created">
                                    Created
                                </th>
                                <th id="file-modified" class="files col-modified">
                                    Modified
                                </th>
                            </tr>
                        </thead>
        ...
        <div id="progress-wrapper">
            <div id="ul-progress">
                ...
                <div class="progress">
                    <span id="ul-progress-text" class="progress-text">&nbsp;</span>
                    <div id="ul-progress-bar" class="progress-bar">
                        &nbsp;
                    </div>
                </div>
            </div>
            <div id="dl-progress">
                ...
                <div class="progress">
                    <span id="dl-progress-text" class="progress-text">&nbsp;</span>
                    <div id="dl-progress-bar" class="progress-bar">
                        &nbsp;
                    </div>
                </div>
            </div>
        ...
        <div id="edit-box">
            <form id="edit-form" name="edit-form">
                <textarea id="edit" rows="20"></textarea><br />
                <input type="hidden" id="edit-action" /> <input type="submit" value="Save" /> <input type="submit" value="Save &amp; Close" /> <input type="submit" value="Close" />
            </form>
        </div>
        <div id="filecolumns-menu" class="contextmenu">
            <label><input type="checkbox" class="column-sel setting" id="chkbx-name" checked="checked" /> Name</label> <label><input type="checkbox" class="column-sel setting" id="chkbx-size" checked="checked" /> Size</label> <label><input type="checkbox" class="column-sel setting" id="chkbx-owner" checked="checked" /> Owner</label> <label><input type="checkbox" class="column-sel setting" id="chkbx-group" checked="checked" /> Group</label> <label><input type="checkbox" class="column-sel setting" id="chkbx-perms" checked="checked" /> Permissions</label> <label><input type="checkbox" class="column-sel setting" id="chkbx-created" checked="checked" /> Created</label> <label><input type="checkbox" class="column-sel setting" id="chkbx-modified" checked="checked" /> Modified</label>
        </div>
    </body>
</html><?php } ?>